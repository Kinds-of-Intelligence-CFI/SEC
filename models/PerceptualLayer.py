...
class Conv_Autoencoder():
    ...
    def update(self, img, batch_size):
        ...
        reconstruct_error = self.autoencoder.evaluate(img, # changed form .fit() to .evaluate()
                                                      img,
...
class PerceptualLayer(object):
    ...
    def __init__(self, prototype_length=20, frozen_weights=False):
    ...
    def load_model(self):
        ...
        if os.path.exists(file_path):
            ...
            if self.frozen:
                self.visual.autoencoder.trainable = False
                print('WEIGHTS FREEZED')
        else:
            print('FILE DOES NOT EXIST')

    def freeze_model(self):
        self.visual.autoencoder.trainable = False
        #self.visual.autoencoder.summary()

    def unfreeze_model(self):
        self.visual.autoencoder.trainable = True
